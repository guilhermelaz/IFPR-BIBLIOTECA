...
<div class="container">
  ...
  <div class="border rounded p-4">
    <h4 class="mb-3"></h4>
    <form action="/u/usuarios" method="POST">
      ...
      <% if (usuarios != null && !usuarios.isEmpty()) { %>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/u/editar-usuario?id=<%=usuario.getId()%>" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Editar</a>
          </td>
        </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="/u/excluir-usuario?id=<%=usuario.getId()%>" class="btn btn-danger">Excluir</a>
            </div>
          </div>
        </div>
      </div>
